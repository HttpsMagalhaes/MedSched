...
$records_pro = [];
$sql_pro = "SELECT * FROM professional WHERE idProfessional = '" . $_GET['idProfessional'] . "'";
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <?php foreach ($records_pro as $record) : ?>
                    <input type="text" class="form-control" id="inputPassword4" value="<?= $record['Name'] ?>" placeholder="Nome completo"  disabled="">
                <?php endforeach ?>
            </div>
            <div class="form-group col-md-6">
