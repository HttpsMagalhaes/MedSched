        ...
        <?php if(isset($records_p)) : ?>
            <?php foreach ($records_p as $record) : ?>
                <tr>
                    ...
                    <td><a href="index.php?dir=paginas&file=consulta_paciente&idProfessional=<?= $record['idProfessional'] ?>" class="btn btn-second" name="marcar"><span class="fa fa-plus"></span></a></td>
                </tr>
            <?php endforeach ?>
            <?php else : ?>
                <tr>
